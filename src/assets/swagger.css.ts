...
.swagger-ui .authorization__btn { filter: invert(100%); }

.swagger-ui .arrow { filter: invert(100%); }
...
.swagger-ui .model-box { background: rgba(0, 0, 0, .1); width: 100%; }
...
.swagger-ui .topbar-wrapper img {
    content:url("/api/static/favicon.jpg")
}
...
.swagger-ui div .information-container.wrapper {
    font-family: "Tilt Neon" !important;
    font-size: 18px;
}

.swagger-ui div .information-container.wrapper li {
    font-family: "Tilt Neon" !important;
    font-size: 16px;
}
...
.swagger-ui table.model tr.property-row {
    border-bottom:solid 1px #5a5a5acc;
}

.swagger-ui table.model tr.property-row:nth-child(odd) {
...
#carousel-inner input:checked + div {
    position: static;
    opacity: 100;
...
#carousel-inner label[name~=prev] {
    left: 2%;
}

#carousel-inner label[name~=next] {
    right: 2%;
}

#carousel-inner label:hover {
    background: rgba(0, 0, 0, 0.8);
    color: #aaaaaa;
}

#carousel-1:checked ~ [name~=control-1],
#carousel-2:checked ~ [name~=control-2],
#carousel-3:checked ~ [name~=control-3] {
    display: block;
}
